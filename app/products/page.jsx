...
const QA_MATRIX = [
  ...
  [<Link key="m" href="/products/minerals" className="egg-link">Industrial Minerals</Link>, 'Silica sand · kaolin · barite · feldspar · talc · bentonite · iron ore · magnetite', 'ISO 3082 (iron ore) / ISO 11648-2 sampling · API 13A (barite)', 'CoA: assay (SiO₂, Fe₂O₃, Al₂O₃, BaSO₄, Fe), moisture, sizing, LOI', 'SGS · BV · Intertek'],
