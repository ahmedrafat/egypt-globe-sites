...
export const STATIC_FAQS = {
  ...
  markets: [
    {
      question: 'How accurate is the pricing in these market briefs?',
      answer: 'Price benchmarks reflect actual FOB Egyptian-port indications observed by our trade desk within the last 30 days, expressed as USD/MT ranges. Spot pricing fluctuates daily — for a binding quote on a specific commodity, grade, and shipment size, use the RFQ form. Quotes are returned within 24 hours.',
    },
    {
      question: 'Can I cite these reports in tender or procurement documents?',
      answer: 'Yes — these are published Egypt Globe Group market briefs. Cite as "Egypt Globe Group — Market Intelligence" with the page URL and access date. For a custom market brief with deeper depth (5-year price history, named producers, freight-lane economics for your specific origin-destination pair), contact our trade desk.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Quarterly refresh on pricing benchmarks, annually on production capacity and producer directories. Significant events (sanctions, force majeure, major capacity additions) trigger out-of-cycle updates. Subscribe via the contact form for email alerts when new briefs ship.',
    },
    {
