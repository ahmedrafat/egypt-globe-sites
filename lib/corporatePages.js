...
export const PRODUCT_DIVISIONS = [
  { id: 'salt',         path: '/products/salt',         label: 'Salt',                  icon: 'cube', color: '#0ea5e9', blurb: 'Sea & rock salt from food and pharma grades to de-icing and chlor-alkali.' },
  { id: 'fertilizers',  path: '/products/fertilizers',  label: 'Fertilizers',           icon: 'wheat', color: '#16a34a', blurb: 'Urea, MOP, TSP, DAP, MAP, NPK, SOP — nitrogen, phosphate and potassium grades.' },
  { id: 'chemicals',    path: '/products/chemicals',    label: 'Chemicals',             icon: 'beaker', color: '#db2777', blurb: 'Industrial chemicals, polymers, plastics, solvents, fuels and petroleum products.' },
  { id: 'construction', path: '/products/construction', label: 'Construction',          icon: 'building', color: '#d97706', blurb: 'Cement, clinker, aggregates, granite, marble, gypsum, limestone, glass, ceramics.' },
  { id: 'agro',         path: '/products/agro',         label: 'Agro & Food',           icon: 'leaf', color: '#059669', blurb: 'Grains, edible oils, cotton, sugar, spices, fresh produce, seafood and animal feed.' },
  { id: 'minerals',     path: '/products/minerals',     label: 'Industrial Minerals',   icon: 'layers',  color: '#64748b', blurb: 'Silica sand, kaolin, barite, feldspar, talc, bentonite, iron ore, coal — raw materials.' },
  { id: 'metals',       path: '/products/metals',       label: 'Metals & Alloys',       icon: 'gear', color: '#71717a', blurb: 'Steel, aluminum, copper, zinc, lead, ferro-alloys and scrap metal.' },
]
