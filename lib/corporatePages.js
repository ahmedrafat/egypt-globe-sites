...
export const APPLICATIONS = [
  ...
  { id: 'retail_horeca',    path: '/applications/retail_horeca',    label: 'Retail & HoReCa',                 icon: '🍽',
    ...
    categories: [],
    divisions: ['salt', 'agro'] },  // salt has 9 table_salt + agro has retail/horeca
