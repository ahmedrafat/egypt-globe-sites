...
export const COMPARE = [
  ...
  ['Moisture',             'Natural 1.0 % or 1.5 % grades · kiln-dried to ≤ 0.25 %, ≤ 0.5 % or ≤ 1.0 % (winter) on request', 'Natural 3–4 % (Type 2) · kiln-dried to ≤ 0.25 %, ≤ 0.5 % or ≤ 1.0 % (winter) on request (Type 1)'],
  ...
  ['Loading ports',        'El Dekheila (EGEDK) · Alexandria (EGALY) · Damietta (EGDAM) · Ain Sokhna (EGSOK)', 'Al-Arish (EGAAC) · Port Said East (EGPSE) · Damietta (EGDAM) · Ain Sokhna (EGSOK)'],
...
export const LOGISTICS = [
  ...
  ['Independent inspection protocol','TÜV Austria (EU / GCC) · SGS · Intertek (ASTM / BS) · Bureau Veritas — pre-shipment sampling per ISO 11648-2, NaCl, moisture and sieve witness tests, draft survey on bulk vessels, sealed retained samples held 90 days'],
...
export const SOURCES = {
  ...
  sea: {
    ...
    ports: [port('Al-Arish', 'EGAAC', '/ports/al-arish-salt'), port('Port Said East', 'EGPSE', '/ports/port-said-east-salt'), port('Damietta', 'EGDAM', '/ports/damietta-salt'), port('Ain Sokhna', 'EGSOK', '/ports/ain-sokhna-salt')],
    bestFor: [
