 ...
 *
 * Light editorial edition (2026-08): ultra-light gray ground with the
 * orange top-accent strip. Brand block + product columns + services
 * column + company links + contact block + Egyptian commercial registry /
 * tax / export-license compliance strip. `settings` prop merges
 * site_settings overrides over the static default.
 *
...
export default function SiteFooter({ settings }) {
  ...
  return (
    <footer className="bg-[#f9fafb] text-[#3f4650] mt-16 sm:mt-24 border-t border-[#14161a]/10">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 pt-10 sm:pt-14 pb-8 sm:pb-10">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-12 gap-x-6 gap-y-8 sm:gap-8">
          ...
          <div className="col-span-2 sm:col-span-2 md:col-span-2 lg:col-span-3">
            <div className="bg-white inline-flex p-3 rounded-xl ring-1 ring-[#14161a]/10 mb-5">
            ...
            {s.linkedin && (
              <a href={s.linkedin} target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-sm text-[#3f4650] hover:text-[#14161a] transition-colors group">
        ...
        {/* ── Compliance strip ─────────────────────────────────── */}
        <div className="mt-12 pt-6 border-t border-[#14161a]/10 grid grid-cols-1 sm:grid-cols-3 gap-3">
          {[
