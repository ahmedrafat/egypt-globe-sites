...
// Tracks the banners' empty left 45%. Solid enough under the headline and
// description (which run to ~62% of the width at lg), then opens up.
const BANNER_SCRIM_LG =
  'linear-gradient(90deg, rgba(3,24,45,.93) 0%, rgba(3,24,45,.86) 48%, rgba(3,24,45,.46) 72%, rgba(3,24,45,.14) 100%)'
